...
@property (nonatomic, readwrite, retain) NSString *serialNo;
@property (nonatomic, readwrite, retain) NSString *deviceManufacturer;
@property (nonatomic, assign) BOOL isOpenUSBDebugModel;
@property (nonatomic, readwrite, retain) NSCondition *deviceCondition;
@property (nonatomic, assign) BOOL isDevicePause;
