...
- (void)queryAllSMSData {
    ...
    if ([self getBackupPath]) {
        _safariData = [[IMBHistorySqliteManager alloc] initWithAMDevice:_device backupfilePath:_backupPath withDBType:_iosVersion WithisEncrypted:_isEncrypted withBackUpDecrypt:_backupDecrypt];
        
        //copy 数据库到log中
        //        [self getSqliteFile];
        
        [_safariData querySqliteDBContent];
    }
}
