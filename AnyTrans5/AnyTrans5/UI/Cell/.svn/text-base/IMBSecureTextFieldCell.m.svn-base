...
//    int oringeCenter = controlView.frame.size.width - 30;
//    [_logBtn setFrameOrigin:NSMakePoint(oringeCenter, frame.origin.y + (frame.size.height - self.logBtn.frame.size.height) / 2)];
//    [controlView addSubview:self.logBtn];
    
//    [_loadLayer setFrame:CGRectMake(_logBtn.frame.origin.x, _logBtn.frame.origin.y, 24, 24)];
//    [controlView setWantsLayer:YES];
//    [controlView.layer addSublayer:_loadLayer];
