...
- (id)init {
    NSImage *unCheckImage = [StringHelper imageNamed:@"sel_non"];
    NSImage *checkImg = [StringHelper imageNamed:@"sel_all"];
    NSImage *mixImg = [StringHelper imageNamed:@"sel_sem"];
...
- (void)setCheckStateImage:(NSString *)btnName {
    _checkImg = [[StringHelper imageNamed:[NSString stringWithFormat:@"%@2",btnName]] retain];
    _unCheckImg = [[StringHelper imageNamed:[NSString stringWithFormat:@"%@1",btnName]] retain];
   [self setImage:_unCheckImg];
}
...
{
    if (value == NSOnState) {
        [self setImage:[StringHelper imageNamed:@"sel_all"]];//box_select1
    }
    else if(value == NSOffState){
        [self setImage:[StringHelper imageNamed:@"sel_non"]];//box_default1
    }
    else if(value == NSMixedState){
        [self setImage:[StringHelper imageNamed:@"sel_sem"]];//box_mix_select1
    }
