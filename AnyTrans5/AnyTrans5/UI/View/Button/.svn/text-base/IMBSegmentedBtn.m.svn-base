...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    if (super.selectedSegment == 0) {
        ...
        if (_leftStatus == 1) {
            //        [IMBTextButton_Normal_BG setFill];
            //        [clipPath fill];
            //        [IMBTextButton_Normal_Border setStroke];
            //        [clipPath stroke];
            ...
            [leftPath addClip];
            [leftPath closePath];
            [[StringHelper getColorFromString:CustomColor(@"listcollection_changBtn_downColor", nil)] setFill];
            [leftPath fill];
            [[StringHelper getColorFromString:CustomColor(@"listcollection_changBtn_downBorderColor", nil)] setStroke];
            [leftPath stroke];
            ...
            [leftPath addClip];
            [leftPath closePath];
            [[StringHelper getColorFromString:CustomColor(@"text_disableColor", nil)] setFill];
            [leftPath fill];
