...
//    }
    ...
    drawingLayer.borderColor = [StringHelper getColorFromString:CustomColor(@"animation_circleColor", nil)].toCGColor;
...
//    }
    ...
    drawingLayer2.borderColor = [StringHelper getColorFromString:CustomColor(@"animation_circleColor", nil)].toCGColor;
