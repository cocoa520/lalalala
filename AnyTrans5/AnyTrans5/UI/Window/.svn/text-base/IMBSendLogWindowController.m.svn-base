...
- (void)sendLog:(id)sender{
    ...
    [_loadLayer setFrame:NSMakeRect( _loadingString.frame.origin.x - 16 , _loadingString.frame.origin.y +7, 16, 16)];
    [self.window.contentView setWantsLayer:YES];
     [[self.window.contentView layer] addSublayer:_loadLayer];
    ...
    [_loadLayer setFrame:NSMakeRect( _loadingString.frame.origin.x - 16 , _loadingString.frame.origin.y +7 , _loadLayer.frame.size.width, _loadLayer.frame.size.height)];
