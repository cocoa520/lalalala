...
//#import "IMBDeviceInforView.h"
#import "IMBCustomButton.h"
//#import "IMBOneKeyButton.h"
//#import "IMBOneKeyfield.h"
...
- (void)drawBaselineSeparator:(NSRect)separatorFrame
{
	...
	if (INRunningLion()) {
		...
		[[StringHelper getColorFromString:CustomColor(@"alert_bgColor", nil)] setFill];
...
//	NSFont *titleFont = window.titleFont ?: [NSFont titleBarFontOfSize:[NSFont systemFontSizeForControlSize:NSRegularControlSize]];
    NSFont *titleFont = [NSFont fontWithName:@"Helvetica Neue light" size:14];
...
{
	if (INRunningLion())
		return [StringHelper getColorFromString:CustomColor(@"alert_bgColor", nil)];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.66 alpha:1.0] : [NSColor colorWithDeviceWhite:0.878 alpha:1.0];
	else
		return [StringHelper getColorFromString:CustomColor(@"alert_bgColor", nil)];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.659 alpha:1.0] : [NSColor colorWithDeviceWhite:0.851 alpha:1.0];
}

+ (NSColor *)defaultTitleBarEndColor:(BOOL)drawsAsMainWindow
{
	if (INRunningLion())
		return [StringHelper getColorFromString:CustomColor(@"alert_bgColor", nil)];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.9 alpha:1.0] : [NSColor colorWithDeviceWhite:0.976 alpha:1.0];
	else
		return [StringHelper getColorFromString:CustomColor(@"alert_bgColor", nil)];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.812 alpha:1.0] : [NSColor colorWithDeviceWhite:0.929 alpha:1.0];
}

+ (NSColor *)defaultBaselineSeparatorColor:(BOOL)drawsAsMainWindow
{
	if (INRunningLion())
		return [StringHelper getColorFromString:CustomColor(@"alert_bgColor", nil)];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.408 alpha:1.0] : [NSColor colorWithDeviceWhite:0.655 alpha:1.0];
	else
		return [StringHelper getColorFromString:CustomColor(@"alert_bgColor", nil)];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.318 alpha:1.0] : [NSColor colorWithDeviceWhite:0.600 alpha:1.0];
}
...
//	return drawsAsMainWindow ? [NSColor colorWithDeviceWhite:56.0/255.0 alpha:1.0] : [NSColor colorWithDeviceWhite:56.0/255.0 alpha:0.5];
    return [StringHelper getColorFromString:CustomColor(@"text_normalColor", nil)];
}
