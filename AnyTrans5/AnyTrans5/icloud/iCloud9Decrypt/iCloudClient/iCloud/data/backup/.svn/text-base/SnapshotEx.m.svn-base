...
- (NSString *)info {
    long long quotaUsed = [self quotaUsed];
    NSString *quota = (quotaUsed > 10737418240 ? [NSString stringWithFormat:@"%6lli GB", ([self quotaUsed] / 10737418240)] : [NSString stringWithFormat:@"%6lli MB", ([self quotaUsed] / 1048576)]);
    return [NSString stringWithFormat:@"%@ %@", quota, [self deviceName]];
}
