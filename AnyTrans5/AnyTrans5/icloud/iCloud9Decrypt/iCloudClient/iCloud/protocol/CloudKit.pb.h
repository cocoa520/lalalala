...
@property (readonly, retain) ErrorEx* error;
...
- (BOOL) hasError;
- (ErrorEx*) error;
- (ResponseOperationResult_Builder*) setError:(ErrorEx*) value;
- (ResponseOperationResult_Builder*) setErrorBuilder:(ErrorEx_Builder*) builderForValue;
- (ResponseOperationResult_Builder*) mergeError:(ErrorEx*) value;
- (ResponseOperationResult_Builder*) clearError;
@end

@interface ErrorEx : PBGeneratedMessage {
@private
  BOOL hasMessage_:1;
  BOOL hasId_:1;
  BOOL hasCode_:1;
...
+ (ErrorEx*) defaultInstance;
- (ErrorEx*) defaultInstance;

- (BOOL) isInitialized;
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output;
- (ErrorEx_Builder*) builder;
+ (ErrorEx_Builder*) builder;
+ (ErrorEx_Builder*) builderWithPrototype:(ErrorEx*) prototype;

+ (ErrorEx*) parseFromData:(NSData*) data;
+ (ErrorEx*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry;
+ (ErrorEx*) parseFromInputStream:(NSInputStream*) input;
+ (ErrorEx*) parseDelimitedFromInputStream:(NSInputStream*) input;
+ (ErrorEx*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry;
+ (ErrorEx*) parseFromCodedInputStream:(PBCodedInputStream*) input;
+ (ErrorEx*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry;
@end

@interface ErrorEx_Builder : PBGeneratedMessage_Builder {
@private
  ErrorEx* result;
}
...
- (ErrorEx_Builder*) clear;
- (ErrorEx_Builder*) clone;

- (ErrorEx*) build;
- (ErrorEx*) buildPartial;

- (ErrorEx_Builder*) mergeFrom:(ErrorEx*) other;
- (ErrorEx_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input;
- (ErrorEx_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry;

- (BOOL) hasCode;
- (UInt32Ex*) code;
- (ErrorEx_Builder*) setCode:(UInt32Ex*) value;
- (ErrorEx_Builder*) setCodeBuilder:(UInt32Ex_Builder*) builderForValue;
- (ErrorEx_Builder*) mergeCode:(UInt32Ex*) value;
- (ErrorEx_Builder*) clearCode;

- (BOOL) hasMessage;
- (NSString*) message;
- (ErrorEx_Builder*) setMessage:(NSString*) value;
- (ErrorEx_Builder*) clearMessage;

- (BOOL) hasId;
- (NSString*) id;
- (ErrorEx_Builder*) setId:(NSString*) value;
- (ErrorEx_Builder*) clearId;
@end
...
@private
  BOOL hasZoneIdentifier_:1;
  BOOL hasProtectionInfo_:1;
  BOOL hasRecordProtectionInfo_:1;
  RecordZoneIdentifier* zoneIdentifier;
  ProtectionInfo* protectionInfo;
  ProtectionInfo* recordProtectionInfo;
}
- (BOOL) hasZoneIdentifier;
- (BOOL) hasProtectionInfo;
...
@property (readonly, retain) RecordZoneIdentifier* zoneIdentifier;
@property (readonly, retain) ProtectionInfo* protectionInfo;
@property (readonly, retain) ProtectionInfo* recordProtectionInfo;
...
- (BOOL) hasRecordProtectionInfo;
- (ProtectionInfo*) recordProtectionInfo;
- (ZoneEx_Builder*) setRecordProtectionInfo:(ProtectionInfo*) value;
- (ZoneEx_Builder*) setRecordProtectionInfoBuilder:(ProtectionInfo_Builder*) builderForValue;
- (ZoneEx_Builder*) mergeRecordProtectionInfo:(ProtectionInfo*) value;
- (ZoneEx_Builder*) clearRecordProtectionInfo;
@end
...
@private
  ...
  BOOL hasSize_:1;
  BOOL hasSizeBeforeCopy_:1;
  BOOL hasDomainOrdinal_:1;
  BOOL hasFlags_:1;
  BOOL hasContentEncodingMethod_:1;
  BOOL hasContentCompressionMethod_:1;
  BOOL hasRelativePath_:1;
  BOOL hasDomain_:1;
  BOOL hasLinkTarget_:1;
  BOOL hasEncryptionKey_:1;
  BOOL hasSha256Signature_:1;
  BOOL hasGroupId_:1;
  BOOL hasUserId_:1;
  BOOL hasMode_:1;
  int64_t birth;
  ...
  int32_t domainOrdinal;
  int32_t flags;
  int32_t contentEncodingMethod;
  int32_t contentCompressionMethod;
...
@property (readonly) int64_t sizeBeforeCopy;
@property (readonly, retain) NSData* linkTarget;
@property (readonly, retain) NSData* encryptionKey;
@property (readonly, retain) NSData* sha256Signature;
@property (readonly) int32_t domainOrdinal;
@property (readonly) int32_t flags;
@property (readonly) int32_t contentEncodingMethod;
@property (readonly) int32_t contentCompressionMethod;
...
- (BOOL) hasSizeBeforeCopy;
- (int64_t) sizeBeforeCopy;
- (EncryptedAttributes_Builder*) setSizeBeforeCopy:(int64_t) value;
- (EncryptedAttributes_Builder*) clearSizeBeforeCopy;

- (BOOL) hasLinkTarget;
- (NSData*) linkTarget;
- (EncryptedAttributes_Builder*) setLinkTarget:(NSData*) value;
- (EncryptedAttributes_Builder*) clearLinkTarget;
...
- (BOOL) hasSha256Signature;
- (NSData*) sha256Signature;
- (EncryptedAttributes_Builder*) setSha256Signature:(NSData*) value;
- (EncryptedAttributes_Builder*) clearSha256Signature;

- (BOOL) hasDomainOrdinal;
- (int32_t) domainOrdinal;
- (EncryptedAttributes_Builder*) setDomainOrdinal:(int32_t) value;
- (EncryptedAttributes_Builder*) clearDomainOrdinal;

- (BOOL) hasFlags;
- (int32_t) flags;
- (EncryptedAttributes_Builder*) setFlags:(int32_t) value;
- (EncryptedAttributes_Builder*) clearFlags;

- (BOOL) hasContentEncodingMethod;
- (int32_t) contentEncodingMethod;
- (EncryptedAttributes_Builder*) setContentEncodingMethod:(int32_t) value;
- (EncryptedAttributes_Builder*) clearContentEncodingMethod;

- (BOOL) hasContentCompressionMethod;
- (int32_t) contentCompressionMethod;
- (EncryptedAttributes_Builder*) setContentCompressionMethod:(int32_t) value;
- (EncryptedAttributes_Builder*) clearContentCompressionMethod;
@end
