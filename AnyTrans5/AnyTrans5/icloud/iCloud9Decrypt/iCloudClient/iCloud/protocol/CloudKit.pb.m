...
- (id) init {
  if ((self = [super init])) {
    self.code = 0;
    self.error = [ErrorEx defaultInstance];
  }
  return self;
}
...
- (ResponseOperationResult_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 18: {
        ErrorEx_Builder* subBuilder = [ErrorEx builder];
        if (self.hasError) {
...
- (ResponseOperationResult_Builder*) mergeError:(ErrorEx*) value {
  if (result.hasError &&
      result.error != [ErrorEx defaultInstance]) {
    result.error =
      [[[ErrorEx builderWithPrototype:result.error] mergeFrom:value] buildPartial];
  } else {
    result.error = value;
  }
  result.hasError = YES;
...
static ErrorEx* defaultErrorExInstance = nil;
+ (void) initialize {
  if (self == [ErrorEx class]) {
    defaultErrorExInstance = [[ErrorEx alloc] init];
  }
}
+ (ErrorEx*) defaultInstance {
  return defaultErrorExInstance;
}
- (ErrorEx*) defaultInstance {
  return defaultErrorExInstance;
}
...
+ (ErrorEx*) parseFromData:(NSData*) data {
  return (ErrorEx*)[[[ErrorEx builder] mergeFromData:data] build];
}
+ (ErrorEx*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (ErrorEx*)[[[ErrorEx builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (ErrorEx*) parseFromInputStream:(NSInputStream*) input {
  return (ErrorEx*)[[[ErrorEx builder] mergeFromInputStream:input] build];
}
+ (ErrorEx*) parseDelimitedFromInputStream:(NSInputStream*) input {
  return (ErrorEx*)[[[ErrorEx builder] mergeDelimitedFromInputStream:input] build];
}
+ (ErrorEx*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (ErrorEx*)[[[ErrorEx builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (ErrorEx*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (ErrorEx*)[[[ErrorEx builder] mergeFromCodedInputStream:input] build];
}
+ (ErrorEx*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (ErrorEx*)[[[ErrorEx builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (ErrorEx_Builder*) builder {
  return [[[ErrorEx_Builder alloc] init] autorelease];
}
+ (ErrorEx_Builder*) builderWithPrototype:(ErrorEx*) prototype {
  return [[ErrorEx builder] mergeFrom:prototype];
}
- (ErrorEx_Builder*) builder {
  return [ErrorEx builder];
}
@end

@interface ErrorEx_Builder()
@property (retain) ErrorEx* result;
@end

@implementation ErrorEx_Builder
@synthesize result;
- (void) dealloc {
  self.result = nil;
  [super dealloc];
...
- (id) init {
  if ((self = [super init])) {
    self.result = [[[ErrorEx alloc] init] autorelease];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (ErrorEx_Builder*) clone {
  return [ErrorEx builderWithPrototype:result];
}
- (ErrorEx*) defaultInstance {
  return [ErrorEx defaultInstance];
}
- (ErrorEx*) build {
  [self checkInitialized];
  return [self buildPartial];
...
- (ErrorEx*) buildPartial {
  ErrorEx* returnMe = [[result retain] autorelease];
  self.result = nil;
  return returnMe;
}
- (ErrorEx_Builder*) mergeFrom:(ErrorEx*) other {
  if (other == [ErrorEx defaultInstance]) {
    return self;
  }
  if (other.hasCode) {
...
@property (retain) RecordZoneIdentifier* zoneIdentifier;
@property (retain) ProtectionInfo* protectionInfo;
@property (retain) ProtectionInfo* recordProtectionInfo;
@end
...
- (BOOL) hasRecordProtectionInfo {
  return !!hasRecordProtectionInfo_;
}
- (void) setHasRecordProtectionInfo:(BOOL) value {
  hasRecordProtectionInfo_ = !!value;
}
@synthesize recordProtectionInfo;
- (void) dealloc {
  self.zoneIdentifier = nil;
  self.protectionInfo = nil;
  self.recordProtectionInfo = nil;
  [super dealloc];
}
- (id) init {
  if ((self = [super init])) {
    self.zoneIdentifier = [RecordZoneIdentifier defaultInstance];
    self.protectionInfo = [ProtectionInfo defaultInstance];
    self.recordProtectionInfo = [ProtectionInfo defaultInstance];
  }
  return self;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasRecordProtectionInfo) {
    [output writeMessage:6 value:self.recordProtectionInfo];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (int32_t) serializedSize {
  ...
  if (self.hasRecordProtectionInfo) {
    size += computeMessageSize(6, self.recordProtectionInfo);
  }
  size += self.unknownFields.serializedSize;
  memoizedSerializedSize = size;
  return size;
...
- (ZoneEx_Builder*) mergeFrom:(ZoneEx*) other {
  ...
  if (other.hasRecordProtectionInfo) {
    [self mergeRecordProtectionInfo:other.recordProtectionInfo];
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 50: {
        ProtectionInfo_Builder* subBuilder = [ProtectionInfo builder];
        if (self.hasRecordProtectionInfo) {
          [subBuilder mergeFrom:self.recordProtectionInfo];
        }
        [input readMessage:subBuilder extensionRegistry:extensionRegistry];
        [self setRecordProtectionInfo:[subBuilder buildPartial]];
        break;
      }
    }
  }
...
- (BOOL) hasRecordProtectionInfo {
  return result.hasRecordProtectionInfo;
}
- (ProtectionInfo*) recordProtectionInfo {
  return result.recordProtectionInfo;
}
- (ZoneEx_Builder*) setRecordProtectionInfo:(ProtectionInfo*) value {
  result.hasRecordProtectionInfo = YES;
  result.recordProtectionInfo = value;
  return self;
}
- (ZoneEx_Builder*) setRecordProtectionInfoBuilder:(ProtectionInfo_Builder*) builderForValue {
  return [self setRecordProtectionInfo:[builderForValue build]];
}
- (ZoneEx_Builder*) mergeRecordProtectionInfo:(ProtectionInfo*) value {
  if (result.hasRecordProtectionInfo &&
      result.recordProtectionInfo != [ProtectionInfo defaultInstance]) {
    result.recordProtectionInfo =
      [[[ProtectionInfo builderWithPrototype:result.recordProtectionInfo] mergeFrom:value] buildPartial];
  } else {
    result.recordProtectionInfo = value;
  }
  result.hasRecordProtectionInfo = YES;
...
- (ZoneEx_Builder*) clearRecordProtectionInfo {
  result.hasRecordProtectionInfo = NO;
  result.recordProtectionInfo = [ProtectionInfo defaultInstance];
  return self;
}
@end
...
@property int64_t sizeBeforeCopy;
@property (retain) NSData* linkTarget;
@property (retain) NSData* encryptionKey;
@property (retain) NSData* sha256Signature;
@property int32_t domainOrdinal;
@property int32_t flags;
@property int32_t contentEncodingMethod;
@property int32_t contentCompressionMethod;
@end
...
- (BOOL) hasSizeBeforeCopy {
  return !!hasSizeBeforeCopy_;
}
- (void) setHasSizeBeforeCopy:(BOOL) value {
  hasSizeBeforeCopy_ = !!value;
}
@synthesize sizeBeforeCopy;
- (BOOL) hasLinkTarget {
  return !!hasLinkTarget_;
}
- (void) setHasLinkTarget:(BOOL) value {
  hasLinkTarget_ = !!value;
}
...
- (BOOL) hasSha256Signature {
  return !!hasSha256Signature_;
}
- (void) setHasSha256Signature:(BOOL) value {
  hasSha256Signature_ = !!value;
}
@synthesize sha256Signature;
- (BOOL) hasDomainOrdinal {
  return !!hasDomainOrdinal_;
}
- (void) setHasDomainOrdinal:(BOOL) value {
  hasDomainOrdinal_ = !!value;
}
@synthesize domainOrdinal;
- (BOOL) hasFlags {
  return !!hasFlags_;
}
...
- (BOOL) hasContentEncodingMethod {
  return !!hasContentEncodingMethod_;
}
- (void) setHasContentEncodingMethod:(BOOL) value {
  hasContentEncodingMethod_ = !!value;
}
@synthesize contentEncodingMethod;
- (BOOL) hasContentCompressionMethod {
  return !!hasContentCompressionMethod_;
}
- (void) setHasContentCompressionMethod:(BOOL) value {
  hasContentCompressionMethod_ = !!value;
}
@synthesize contentCompressionMethod;
- (void) dealloc {
  self.relativePath = nil;
  self.domain = nil;
  self.linkTarget = nil;
  self.encryptionKey = nil;
  self.sha256Signature = nil;
  [super dealloc];
}
- (id) init {
  if ((self = [super init])) {
    ...
    self.userId = 0;
    self.mode = 0;
    self.sizeBeforeCopy = 0L;
    self.linkTarget = [NSData data];
    self.encryptionKey = [NSData data];
    self.sha256Signature = [NSData data];
    self.domainOrdinal = 0;
    self.flags = 0;
    self.contentEncodingMethod = 0;
    self.contentCompressionMethod = 0;
  }
  return self;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasSizeBeforeCopy) {
    [output writeUInt64:10 value:self.sizeBeforeCopy];
  }
  if (self.hasLinkTarget) {
    [output writeData:11 value:self.linkTarget];
  }
  if (self.hasEncryptionKey) {
    [output writeData:12 value:self.encryptionKey];
  }
  if (self.hasSha256Signature) {
    [output writeData:13 value:self.sha256Signature];
  }
  if (self.hasDomainOrdinal) {
    [output writeInt32:14 value:self.domainOrdinal];
  }
  if (self.hasFlags) {
    [output writeInt32:15 value:self.flags];
  }
  if (self.hasContentEncodingMethod) {
    [output writeInt32:16 value:self.contentEncodingMethod];
  }
  if (self.hasContentCompressionMethod) {
    [output writeInt32:17 value:self.contentCompressionMethod];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (int32_t) serializedSize {
  ...
  if (self.hasSizeBeforeCopy) {
    size += computeUInt64Size(10, self.sizeBeforeCopy);
  }
  if (self.hasLinkTarget) {
    size += computeDataSize(11, self.linkTarget);
  }
  if (self.hasEncryptionKey) {
    size += computeDataSize(12, self.encryptionKey);
  }
  if (self.hasSha256Signature) {
    size += computeDataSize(13, self.sha256Signature);
  }
  if (self.hasDomainOrdinal) {
    size += computeInt32Size(14, self.domainOrdinal);
  }
  if (self.hasFlags) {
    size += computeInt32Size(15, self.flags);
  }
  if (self.hasContentEncodingMethod) {
    size += computeInt32Size(16, self.contentEncodingMethod);
  }
  if (self.hasContentCompressionMethod) {
    size += computeInt32Size(17, self.contentCompressionMethod);
  }
  size += self.unknownFields.serializedSize;
  memoizedSerializedSize = size;
  return size;
...
- (EncryptedAttributes_Builder*) mergeFrom:(EncryptedAttributes*) other {
  ...
  if (other.hasSizeBeforeCopy) {
    [self setSizeBeforeCopy:other.sizeBeforeCopy];
  }
  if (other.hasLinkTarget) {
    [self setLinkTarget:other.linkTarget];
  }
  if (other.hasEncryptionKey) {
    [self setEncryptionKey:other.encryptionKey];
  }
  if (other.hasSha256Signature) {
    [self setSha256Signature:other.sha256Signature];
  }
  if (other.hasDomainOrdinal) {
    [self setDomainOrdinal:other.domainOrdinal];
  }
  if (other.hasFlags) {
    [self setFlags:other.flags];
  }
  if (other.hasContentEncodingMethod) {
    [self setContentEncodingMethod:other.contentEncodingMethod];
  }
  if (other.hasContentCompressionMethod) {
    [self setContentCompressionMethod:other.contentCompressionMethod];
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
...
- (EncryptedAttributes_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 80: {
        [self setSizeBeforeCopy:[input readUInt64]];
        break;
      }
      case 90: {
        [self setLinkTarget:[input readData]];
        break;
      }
      case 98: {
      ...
      case 106: {
        [self setSha256Signature:[input readData]];
        break;
      }
      case 112: {
        [self setDomainOrdinal:[input readInt32]];
        break;
      }
      case 120: {
      ...
      case 128: {
        [self setContentEncodingMethod:[input readInt32]];
        break;
      }
      case 136: {
        [self setContentCompressionMethod:[input readInt32]];
        break;
      }
    }
  }
...
- (BOOL) hasSizeBeforeCopy {
  return result.hasSizeBeforeCopy;
}
- (int64_t) sizeBeforeCopy {
  return result.sizeBeforeCopy;
}
- (EncryptedAttributes_Builder*) setSizeBeforeCopy:(int64_t) value {
  result.hasSizeBeforeCopy = YES;
  result.sizeBeforeCopy = value;
  return self;
}
- (EncryptedAttributes_Builder*) clearSizeBeforeCopy {
  result.hasSizeBeforeCopy = NO;
  result.sizeBeforeCopy = 0L;
  return self;
}
- (BOOL) hasLinkTarget {
  return result.hasLinkTarget;
}
- (NSData*) linkTarget {
  return result.linkTarget;
}
- (EncryptedAttributes_Builder*) setLinkTarget:(NSData*) value {
  result.hasLinkTarget = YES;
  result.linkTarget = value;
  return self;
}
- (EncryptedAttributes_Builder*) clearLinkTarget {
  result.hasLinkTarget = NO;
  result.linkTarget = [NSData data];
  return self;
}
- (BOOL) hasEncryptionKey {
...
- (BOOL) hasSha256Signature {
  return result.hasSha256Signature;
}
- (NSData*) sha256Signature {
  return result.sha256Signature;
}
- (EncryptedAttributes_Builder*) setSha256Signature:(NSData*) value {
  result.hasSha256Signature = YES;
  result.sha256Signature = value;
  return self;
}
- (EncryptedAttributes_Builder*) clearSha256Signature {
  result.hasSha256Signature = NO;
  result.sha256Signature = [NSData data];
  return self;
}
- (BOOL) hasDomainOrdinal {
  return result.hasDomainOrdinal;
}
- (int32_t) domainOrdinal {
  return result.domainOrdinal;
}
- (EncryptedAttributes_Builder*) setDomainOrdinal:(int32_t) value {
  result.hasDomainOrdinal = YES;
  result.domainOrdinal = value;
  return self;
}
- (EncryptedAttributes_Builder*) clearDomainOrdinal {
  result.hasDomainOrdinal = NO;
  result.domainOrdinal = 0;
  return self;
}
- (BOOL) hasFlags {
...
- (BOOL) hasContentEncodingMethod {
  return result.hasContentEncodingMethod;
}
- (int32_t) contentEncodingMethod {
  return result.contentEncodingMethod;
}
- (EncryptedAttributes_Builder*) setContentEncodingMethod:(int32_t) value {
  result.hasContentEncodingMethod = YES;
  result.contentEncodingMethod = value;
  return self;
}
- (EncryptedAttributes_Builder*) clearContentEncodingMethod {
  result.hasContentEncodingMethod = NO;
  result.contentEncodingMethod = 0;
  return self;
}
- (BOOL) hasContentCompressionMethod {
  return result.hasContentCompressionMethod;
}
- (int32_t) contentCompressionMethod {
  return result.contentCompressionMethod;
}
- (EncryptedAttributes_Builder*) setContentCompressionMethod:(int32_t) value {
  result.hasContentCompressionMethod = YES;
  result.contentCompressionMethod = value;
  return self;
}
- (EncryptedAttributes_Builder*) clearContentCompressionMethod {
  result.hasContentCompressionMethod = NO;
  result.contentCompressionMethod = 0;
  return self;
}
@end
