...
{
    if (self = [super initParamASN1EncodableVector:paramASN1EncodableVector paramBoolean:YES]) {
        [self setBodyLength:-1];
        return self;
    }else {
#if !__has_feature(objc_arc)
...
{
    if (self = [super initParamArrayOfASN1Encodable:paramArrayOfASN1Encodable paramBoolean:YES]) {
        [self setBodyLength:-1];
        return self;
    }else {
#if !__has_feature(objc_arc)
...
{
    if (self = [super initParamASN1EncodableVector:paramASN1EncodableVector paramBoolean:paramBoolean]) {
        [self setBodyLength:-1];
        return self;
    }else {
#if !__has_feature(objc_arc)
