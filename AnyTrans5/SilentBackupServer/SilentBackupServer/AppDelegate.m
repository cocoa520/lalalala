...
- (void)deviceConnected:(NSNotification *)notification {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (!openUrl) {
            ...
            [logmanager writeInfoLog:@"uninstall Anytrans,unload com.imobie.airbackuphelper.plist"];
            BOOL ret = NO;
            ...
            [logmanager writeInfoLog:@"remove com.imobie.airbackuphelper.plist complete"];
            //卸载服务
            char *cmd = "launchctl unload ~/Library/LaunchAgents/com.imobie.airbackuphelper.plist";
            int i = system(cmd);
            NSLog(@"i=%d",i);
            [logmanager writeInfoLog:@"unload com.imobie.airbackuphelper.plist complete"];
            ...
            [logmanager writeInfoLog:[NSString stringWithFormat:@"unload com.imobie.airbackuphelper.plist == %hhd",ret]];
            return ;
        }
