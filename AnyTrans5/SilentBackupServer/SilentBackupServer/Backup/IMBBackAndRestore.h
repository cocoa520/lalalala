...
@interface IMBBackAndRestore : NSObject {
    ...
    long long _backupTime;
    BOOL _isIncremental;
    BOOL _isEncryptBackup;
}
...
@property (nonatomic, readwrite) long long backupTime;
@property (nonatomic, readwrite) BOOL isIncremental;
@property (nonatomic, readwrite) BOOL isEncryptBackup;
@property (nonatomic, readwrite) BOOL backupFinished;
