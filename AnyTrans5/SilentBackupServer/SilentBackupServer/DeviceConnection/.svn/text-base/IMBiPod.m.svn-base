...
//        _appConfig = nil;
//    }
    if (_backupConfig != nil) {
        [_backupConfig release];
        _backupConfig = nil;
    }
...
- (IMBWifiBackupConfig *)backupConfig {
    if (_backupConfig) {
        [_backupConfig release];
        _backupConfig = nil;
    }
    _backupConfig = [[IMBWifiBackupConfig alloc] initWithiPod:self];
