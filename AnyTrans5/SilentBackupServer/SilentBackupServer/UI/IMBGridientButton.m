...
//    oneLayer.name = @"one";
//    NSImage *image1 = [NSImage imageNamed:@"next_light"];
...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    if (color) {
        ...
        if (_hasRightImage) {
            ...
            [_buttonTitle drawInRect:NSMakeRect(drawRect.origin.x + 2,(drawRect.size.height - titleRect.size.height) / 2.0 - 4, titleRect.size.width, titleRect.size.height) withAttributes:dic];
        } else {
