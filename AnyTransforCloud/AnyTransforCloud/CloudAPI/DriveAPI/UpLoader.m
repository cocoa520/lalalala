    ...
    if ([[NSThread currentThread] isMainThread]) {
        if ([item respondsToSelector:@selector(setCurrentSize:)]) {
            ...
            if (item.parent == nil){
                ...
                item.currentProgressStr = [NSString stringWithFormat:CustomLocalizedString(@"transfer_progrss", nil),(int)(currentSize * 100.0/ item.fileSize)];
            }else{
                ...
                item.parent.currentProgressStr = [NSString stringWithFormat:CustomLocalizedString(@"transfer_progrss", nil),(int)(item.parent.currentSize * 100.0/ item.parent.fileSize)];
            }
