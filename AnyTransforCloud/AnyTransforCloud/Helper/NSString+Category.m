...
+ (NSString*)generateGUID {
    ...
    NSString *guid = [NSString stringWithFormat:@"%@", (NSString *)CFUUIDCreateString(kCFAllocatorDefault, guidref)];
    CFRelease(guidref);
    return guid;
}
...
- (NSRange)rangeOfString:(NSString*)subString atOccurrence:(int)occurrence {
	...
	while (YES) {
		...
		unsigned long newLocationToStartAt = searchResult.location + searchResult.length;
