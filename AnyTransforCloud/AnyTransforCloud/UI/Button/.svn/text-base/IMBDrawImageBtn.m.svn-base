...
@implementation IMBDrawImageBtn
    ...
    if (_longTimeDown) {
        ...
        if (_buttonType == MouseOut){
            if (_mouseExitedImage !=nil) {
                ...
                //            [_mouseExitedImage drawInRect:dirtyRect fromRect:sourceimageRect operation:NSCompositeSourceOver fraction:1.0];
                [_mouseExitedImage drawInRect:NSMakeRect(ceil((self.frame.size.width - sourceimageRect.size.width)/2.0), ceil((self.frame.size.height - sourceimageRect.size.height)/2.0), sourceimageRect.size.width, sourceimageRect.size.height) fromRect:sourceimageRect operation:NSCompositeSourceOver fraction:1.0 respectFlipped:YES hints:nil];
            }
            ...
            if (_mouseUpImage != nil) {
                ...
                [_mouseUpImage drawInRect:NSMakeRect(ceil((self.frame.size.width - sourceimageRect.size.width)/2.0), ceil((self.frame.size.height - sourceimageRect.size.height)/2.0), sourceimageRect.size.width, sourceimageRect.size.height) fromRect:sourceimageRect operation:NSCompositeSourceOver fraction:1.0 respectFlipped:YES hints:nil];
            }
            ...
            if (_mouseDownImage != nil) {
                ...
                [_mouseDownImage drawInRect:NSMakeRect(ceil((self.frame.size.width - sourceimageRect.size.width)/2.0), ceil((self.frame.size.height - sourceimageRect.size.height)/2.0), sourceimageRect.size.width, sourceimageRect.size.height) fromRect:sourceimageRect operation:NSCompositeSourceOver fraction:1.0 respectFlipped:YES hints:nil];
            }
            ...
            if (_mouseEnteredImage != nil) {
                ...
                [_mouseEnteredImage drawInRect:NSMakeRect(ceil((self.frame.size.width - sourceimageRect.size.width)/2.0), ceil((self.frame.size.height - sourceimageRect.size.height)/2.0), sourceimageRect.size.width, sourceimageRect.size.height) fromRect:sourceimageRect operation:NSCompositeSourceOver fraction:1.0 respectFlipped:YES hints:nil];
            }
        }else{
            if (_mouseExitedImage != nil) {
                sourceimageRect.origin = NSZeroPoint;
