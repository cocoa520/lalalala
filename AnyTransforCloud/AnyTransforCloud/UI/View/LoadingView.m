...
//    }
    ...
    drawingLayer.borderColor = [StringHelper getColorFromString:CustomColor(@"text_click_normalColor", nil)].CGColor;
    ...
    drawingLayer2.borderColor = [StringHelper getColorFromString:CustomColor(@"text_click_normalColor", nil)].CGColor;
