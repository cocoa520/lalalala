...
@interface OIDAuthorizationRequest : NSObject <NSCopying, NSSecureCoding> {
  ...
  BOOL _bodyNeedClientandSecret;
}
@property (nonatomic,assign)BOOL bodyNeedClientandSecret;
