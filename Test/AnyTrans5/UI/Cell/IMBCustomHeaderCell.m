...
- (id)initWithCell:(NSTableHeaderCell*)cell
{
	...
	if (self) {
        ...
        [attributedString addAttribute:NSForegroundColorAttributeName value:[StringHelper getColorFromString:CustomColor(@"text_normalColor", nil)] range:NSMakeRange(0, [attributedString length])];
        ...
        _ascendingImage = [[StringHelper imageNamed:@"list_arrow"] retain];
        _descendingImage  = [[StringHelper imageNamed:@"list_arrow2"] retain];
