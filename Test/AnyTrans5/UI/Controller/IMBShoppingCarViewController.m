...
//        str = @"http://www.imobie.jp/anytrans/buy-mac.htm?%@";
//    }else if ([IMBSoftWareInfo singleton].chooseLanguageType == GermanLanguage){
//        str = @"http://www.imobie.de/anytrans/buy-mac.htm?%@";
//    }else if ([IMBSoftWareInfo singleton].chooseLanguageType == FrenchLanguage) {
//        str = @"http://www.imobie.fr/anytrans/buy-mac.htm?%@";
//    }else if ([IMBSoftWareInfo singleton].chooseLanguageType == EnglishLanguage){
//        str = @"http://www.imobie.com/anytrans/buy-mac.htm?%@";
//    }else if ([IMBSoftWareInfo singleton].chooseLanguageType == SpanishLanguage){
//        str = @"https://www.imobie.es/anytrans/buy-mac.htm?%@";
//    }else if ([IMBSoftWareInfo singleton].chooseLanguageType == ArabLanguage){
//        str = @"https://ar.imobie.com/anytrans/buy-mac.htm?%@";
//    }else{
//        str = @"http://www.imobie.com/anytrans/buy-mac.htm?%@";
//    }
    
    //    if (![StringHelper stringIsNilOrEmpty:lanStr]) {
    //        if ([[lanStr lowercaseString] isEqualToString:@"ja"]) {
    //            str = @"http://www.imobie.jp/anytrans/buy-mac.htm?%@";
    //        } else if ([[lanStr lowercaseString] isEqualToString:@"de"]) {
    //            str = @"http://www.imobie.de/anytrans/buy-mac.htm?%@";
    //        } else if ([[lanStr lowercaseString] isEqualToString:@"fr"]) {
    //            str = @"http://www.imobie.fr/anytrans/buy-mac.htm?%@";
    //        }else {
    //            str = @"http://www.imobie.com/anytrans/buy-mac.htm?%@";
    //        }
