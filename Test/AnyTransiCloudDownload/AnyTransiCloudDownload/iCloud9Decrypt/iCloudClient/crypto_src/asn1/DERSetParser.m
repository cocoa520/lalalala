...
- (ASN1Primitive *)getLoadedObject {
    return [[[DERSet alloc] initDERParamASN1EncodableVector:[self.parser readVector] paramBoolean:false] autorelease];
}
