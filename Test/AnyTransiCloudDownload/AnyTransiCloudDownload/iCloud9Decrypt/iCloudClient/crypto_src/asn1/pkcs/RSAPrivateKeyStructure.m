...
@interface RSAPrivateKeyStructure ()
...
@implementation RSAPrivateKeyStructure
...
+ (RSAPrivateKeyStructure *)getInstance:(id)paramObject {
    if ([paramObject isKindOfClass:[RSAPrivateKeyStructure class]]) {
        return (RSAPrivateKeyStructure *)paramObject;
    }
    if (paramObject) {
        return [[[RSAPrivateKeyStructure alloc] initParamASN1Sequence:[ASN1Sequence getInstance:paramObject]] autorelease];
    }
...
+ (RSAPrivateKeyStructure *)getInstance:(ASN1TaggedObject *)paramASN1TaggedObject paramBoolean:(BOOL)paramBoolean {
    return [RSAPrivateKeyStructure getInstance:[ASN1Sequence getInstance:paramASN1TaggedObject paramBoolean:paramBoolean]];
}
...
- (instancetype)initParamASN1Sequence:(ASN1Sequence *)paramASN1Sequence
{
    if (self = [super init]) {
        ...
        self.version = [localBigInteger intValue];
