...
+ (uint)add:(NSMutableArray*)x withY:(NSMutableArray*)y withZ:(NSMutableArray*)z {
    ...
    @autoreleasepool {
        ...
        z[6] = @((uint)c);
        c >>= 32;
        c += [x[7] unsignedLongLongValue] + [y[7] unsignedIntValue];
        z[7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)add:(NSMutableArray*)x withXoff:(int)xOff withY:(NSMutableArray*)y withYoff:(int)yOff withZ:(NSMutableArray*)z withZoff:(int)zOff {
    ...
    @autoreleasepool {
        ...
        z[zOff + 6] = @((uint)c);
        c >>= 32;
        c += [x[xOff + 7] unsignedLongLongValue] + [y[yOff + 7] unsignedIntValue];
        z[zOff + 7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)addBothTo:(NSMutableArray*)x withY:(NSMutableArray*)y withZ:(NSMutableArray*)z {
    ...
    @autoreleasepool {
        ...
        z[6] = @((uint)c);
        c >>= 32;
        c += [x[7] unsignedLongLongValue] + [y[7] unsignedIntValue] + [z[7] unsignedIntValue];
        z[7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)addBothTo:(NSMutableArray*)x withXoff:(int)xOff withY:(NSMutableArray*)y withYoff:(int)yOff withZ:(NSMutableArray*)z withZoff:(int)zOff {
    ...
    @autoreleasepool {
        ...
        z[zOff + 6] = @((uint)c);
        c >>= 32;
        c += [x[xOff + 7] unsignedLongLongValue] + [y[yOff + 7] unsignedIntValue] + [z[zOff + 7] unsignedIntValue];
        z[zOff + 7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)addTo:(NSMutableArray*)x withZ:(NSMutableArray*)z {
    ...
    @autoreleasepool {
        ...
        z[6] = @((uint)c);
        c >>= 32;
        c += [x[7] unsignedLongLongValue] + [z[7] unsignedIntValue];
        z[7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)addTo:(NSMutableArray*)x withXoff:(int)xOff withZ:(NSMutableArray*)z withZoff:(int)zOff withCin:(uint)cIn {
    ...
    @autoreleasepool {
        ...
        z[zOff + 6] = @((uint)c);
        c >>= 32;
        c += [x[xOff + 7] unsignedLongLongValue] + [z[zOff + 7] unsignedIntValue];
        z[zOff + 7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)addToEachOther:(NSMutableArray*)u withUoff:(int)uOff withV:(NSMutableArray*)v withVoff:(int)vOff {
    ...
    @autoreleasepool {
        ...
        v[vOff + 6] = @((uint)c);
        c >>= 32;
        c += [u[uOff + 7] unsignedLongLongValue] + [v[vOff + 7] unsignedIntValue];
        u[uOff + 7] = @((uint)c);
        v[vOff + 7] = @((uint)c);
        c >>= 32;
    }
...
+ (NSMutableArray*)createExt {
    return [[NSMutableArray alloc] initWithSize:16];
}
...
+ (BOOL)diff:(NSMutableArray*)x withXoff:(int)xOff withY:(NSMutableArray*)y withYoff:(int)yOff withZ:(NSMutableArray*)z withZoff:(int)zOff {
    BOOL pos = [Nat256 gte:x withXoff:xOff withY:y withYoff:yOff];
    if (pos) {
        [Nat256 sub:x withXoff:xOff withY:y withYoff:yOff withZ:z withZoff:zOff];
    } else {
        [Nat256 sub:y withXoff:yOff withY:x withYoff:xOff withZ:z withZoff:zOff];
    }
    return pos;
}
...
+ (void)mul:(NSMutableArray*)x withY:(NSMutableArray*)y withZZ:(NSMutableArray*)zz {
    @autoreleasepool {
        ...
        uint64_t y_7 = [y[7] unsignedLongLongValue];
        ...
        for (int i = 1; i < 8; ++i) {
            ...
            zz[i + 6] = @((uint)c);
            c >>= 32;
            c += x_i * y_7 + [zz[i + 7] unsignedIntValue];
            zz[i + 7] = @((uint)c);
            c >>= 32;
            zz[i + 8] = @((uint)c);
        }
...
+ (void)mul:(NSMutableArray*)x withXoff:(int)xOff withY:(NSMutableArray*)y withYoff:(int)yOff withZZ:(NSMutableArray*)zz withZZoff:(int)zzOff {
    @autoreleasepool {
        ...
        uint64_t y_7 = [y[yOff + 7] unsignedLongLongValue];
        ...
        for (int i = 1; i < 8; ++i) {
            ...
            zz[zzOff + 6] = @((uint)c);
            c >>= 32;
            c += x_i * y_7 + [zz[zzOff + 7] unsignedIntValue];
            zz[zzOff + 7] = @((uint)c);
            c >>= 32;
            zz[zzOff + 8] = @((uint)c);
        }
...
+ (uint)mulAddTo:(NSMutableArray*)x withXoff:(int)xOff withY:(NSMutableArray*)y withYoff:(int)yOff withZZ:(NSMutableArray*)zz withZZoff:(int)zzOff {
    ...
    @autoreleasepool {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            zz[zzOff + 7] = @((uint)c);
            c >>= 32;
            c += zc + [zz[zzOff + 8] unsignedIntValue];
            zz[zzOff + 8] = @((uint)c);
            zc = c >> 32;
            ++zzOff;
        }
...
+ (uint64_t)mul33Add:(uint)w withX:(NSMutableArray*)x withXoff:(int)xOff withY:(NSMutableArray*)y withYoff:(int)yOff withZ:(NSMutableArray*)z withZoff:(int)zOff {
    ...
    @autoreleasepool {
        ...
        z[zOff + 6] = @((uint)c);
        c >>= 32;
        uint64_t x7 = [x[xOff + 7] unsignedLongLongValue];
        c += wVal * x7 + x6 + [y[yOff + 7] unsignedIntValue];
        z[zOff + 7] = @((uint)c);
        c >>= 32;
        c += x7;
    }
...
+ (uint)mulByWord:(uint)x withZ:(NSMutableArray*)z {
    ...
    @autoreleasepool {
        ...
        z[6] = @((uint)c);
        c >>= 32;
        c += xVal * [z[7] unsignedLongLongValue];
        z[7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)mulByWordAddTo:(uint)x withY:(NSMutableArray*)y withZ:(NSMutableArray*)z {
    ...
    @autoreleasepool {
        ...
        z[6] = @((uint)c);
        c >>= 32;
        c += xVal * [z[7] unsignedLongLongValue] + [y[7] unsignedIntValue];
        z[7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)mulWordAddTo:(uint)x withY:(NSMutableArray*)y withYoff:(int)yOff withZ:(NSMutableArray*)z withZoff:(int)zOff {
    ...
    @autoreleasepool {
        ...
        z[zOff + 6] = @((uint)c);
        c >>= 32;
        c += xVal * [y[yOff + 7] unsignedIntValue] + [z[zOff + 7] unsignedIntValue];
        z[zOff + 7] = @((uint)c);
        c >>= 32;
    }
    return (uint)c;
...
+ (uint)mul33DWordAdd:(uint)x withY:(uint64_t)y withZ:(NSMutableArray*)z withZoff:(int)zOff {
    ...
    @autoreleasepool {
        ...
        z[zOff + 3] = @((uint)c);
        c >>= 32;
        retVal = (c == 0 ? 0 : [Nat incAt:8 withZ:z withZoff:zOff withZpos:4]);
    }
    return retVal;
}
...
+ (uint)mul33WordAdd:(uint)x withY:(uint)y withZ:(NSMutableArray*)z withZoff:(int)zOff {
    ...
    @autoreleasepool {
        ...
        z[zOff + 2] = @((uint)c);
        c >>= 32;
        retVal = (c == 0 ? 0 : [Nat incAt:8 withZ:z withZoff:zOff withZpos:3]);
    }
    return retVal;
}
...
+ (void)square:(NSMutableArray*)x withZZ:(NSMutableArray*)zz {
    @autoreleasepool {
        ...
        uint64_t x_7 = [x[7] unsignedLongLongValue];
        uint64_t zz_13 = [zz[13] unsignedLongLongValue];
        uint64_t zz_14 = [zz[14] unsignedLongLongValue];
        {
            zz_7 += x_7 * x_0;
            w = (uint)zz_7;
            zz[7] = @((w << 1) | c);
        ...
        zz[14] = @((w << 1) | c);
        c = w >> 31;
        w = [zz[15] unsignedIntValue] + (uint)(zz_14 >> 32);
        zz[15] = @((w << 1) | c);
    }
}
...
+ (void)square:(NSMutableArray*)x withXoff:(int)xOff withZZ:(NSMutableArray*)zz withZZoff:(int)zzOff {
    @autoreleasepool {
        ...
        uint64_t x_7 = [x[xOff + 7] unsignedLongLongValue];
        uint64_t zz_13 = [zz[zzOff + 13] unsignedLongLongValue];
        uint64_t zz_14 = [zz[zzOff + 14] unsignedLongLongValue];
        {
            zz_7 += x_7 * x_0;
            w = (uint)zz_7;
            zz[zzOff + 7] = @((w << 1) | c);
        ...
        zz[zzOff + 14] = @((w << 1) | c);
        c = w >> 31;
        w = [zz[zzOff + 15] unsignedIntValue] + (uint)(zz_14 >> 32);
        zz[zzOff + 15] = @((w << 1) | c);
    }
}
...
+ (int)sub:(NSMutableArray*)x withY:(NSMutableArray*)y withZ:(NSMutableArray*)z {
    ...
    @autoreleasepool {
        ...
        z[6] = @((uint)c);
        c >>= 32;
        c += [x[7] longLongValue] - [y[7] unsignedIntValue];
        z[7] = @((uint)c);
        c >>= 32;
    }
    return (int)c;
...
+ (int)sub:(NSMutableArray*)x withXoff:(int)xOff withY:(NSMutableArray*)y withYoff:(int)yOff withZ:(NSMutableArray*)z withZoff:(int)zOff {
    ...
    @autoreleasepool {
        ...
        z[zOff + 6] = @((uint)c);
        c >>= 32;
        c += [x[xOff + 7] longLongValue] - [y[yOff + 7] unsignedIntValue];
        z[zOff + 7] = @((uint)c);
        c >>= 32;
    }
    return (int)c;
...
+ (int)subBothFrom:(NSMutableArray*)x withY:(NSMutableArray*)y withZ:(NSMutableArray*)z {
    ...
    @autoreleasepool {
        ...
        z[6] = @((uint)c);
        c >>= 32;
        c += [z[7] longLongValue] - [x[7] unsignedIntValue] - [y[7] unsignedIntValue];
        z[7] = @((uint)c);
        c >>= 32;
    }
    return (int)c;
...
+ (int)subFrom:(NSMutableArray*)x withZ:(NSMutableArray*)z {
    ...
    @autoreleasepool {
        ...
        z[6] = @((uint)c);
        c >>= 32;
        c += [z[7] longLongValue] - [x[7] unsignedIntValue];
        z[7] = @((uint)c);
        c >>= 32;
    }
    return (int)c;
...
+ (int)subFrom:(NSMutableArray*)x withXoff:(int)xOff withZ:(NSMutableArray*)z withZoff:(int)zOff {
    ...
    @autoreleasepool {
        ...
        z[zOff + 6] = @((uint)c);
        c >>= 32;
        c += [z[zOff + 7] longLongValue] - [x[xOff + 7] unsignedIntValue];
        z[zOff + 7] = @((uint)c);
        c >>= 32;
    }
    return (int)c;
...
+ (BigInteger*)toBigInteger:(NSMutableArray*)x {
    ...
    @autoreleasepool {
        NSMutableData *bs = [[NSMutableData alloc] initWithSize:32];
        for (int i = 0; i < 8; ++i) {
            uint x_i = [x[i] unsignedIntValue];
            if (x_i != 0) {
                [Pack UInt32_To_BE:x_i withBs:bs withOff:((7 - i) << 2)];
            }
        }
...
+ (BigInteger*)toBigInteger64:(NSMutableArray*)x {
    ...
    @autoreleasepool {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            if (x_i != 0L) {
                [Pack UInt64_To_BE:x_i withBs:bs withOff:((3 - i) << 3)];
            }
        }
        retVal = [[BigInteger alloc] initWithSign:1 withBytes:bs];
#if !__has_feature(objc_arc)
