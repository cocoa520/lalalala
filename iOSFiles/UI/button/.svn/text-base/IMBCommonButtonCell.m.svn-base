...
- (void)drawWithFrame:(NSRect)cellFrame inView:(NSView *)controlView {
    ...
    if (self.mouseStatus == MouseEnter || self.mouseStatus == MouseUp) {
        NSImage *bglImg = [NSImage imageNamed:self.prefixMouseEnterPicName];
        NSImage *bgmImg = [NSImage imageNamed:self.middleMouseEnterPicName];
        NSImage *bgrImg = [NSImage imageNamed:self.suffixMouseEnterPicName];
        ...
        NSImage *bglImg = [NSImage imageNamed:self.prefixMouseDownPicName];
        NSImage *bgmImg = [NSImage imageNamed:self.middleMouseDownPicName];
        NSImage *bgrImg = [NSImage imageNamed:self.suffixMouseDownPicName];
        float yPos = (cellFrame.size.height - bglImg.size.height) / 2;
        if (bglImg != nil && bgmImg != nil && bgrImg != nil) {
            pixHeight = bglImg.size.height;
            NSRect lineRect  = NSZeroRect;
        ...
        NSImage *bglImg = [NSImage imageNamed:self.prefixMouseOutPicName];
        NSImage *bgmImg = [NSImage imageNamed:self.middleMouseOutPicName];
        NSImage *bgrImg = [NSImage imageNamed:self.suffixMouseOutPicName];
        float yPos = (cellFrame.size.height - bglImg.size.height) / 2;
        if (bglImg != nil && bgmImg != nil && bgrImg != nil) {
            pixHeight = bglImg.size.height;
            NSRect lineRect  = NSZeroRect;
