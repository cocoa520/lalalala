...
NSString * const IMBLimitationViewClosedNoti = @"IMBLimitationViewClosedNoti";
...
NSString * const DeviceDataLoadCompleteAppDoucment = @"DeviceDataLoadCompleteAppDoucment";
