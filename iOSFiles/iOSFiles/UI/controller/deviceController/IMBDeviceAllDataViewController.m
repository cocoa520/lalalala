...
- (void)showDeviceDetailView:(id)sender {
    if (_isShow) {
        ...
        [_detailSizeContent setStringValue:[NSString stringWithFormat:@"%@ / %@",[StringHelper getFileSizeString:_iPod.deviceInfo.availableFreeSpace reserved:2],[StringHelper getFileSizeString:_iPod.deviceInfo.totalSize reserved:2]]];
