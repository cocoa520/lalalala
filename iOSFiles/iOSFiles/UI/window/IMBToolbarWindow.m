...
//    [[[self contentView] superview] setWantsLayer:YES];
//    [[[self contentView] superview].layer setCornerRadius:5];
...
{
	if (INRunningLion())
		return [NSColor redColor];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.66 alpha:1.0] : [NSColor colorWithDeviceWhite:0.878 alpha:1.0];
	else
		return [NSColor redColor];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.659 alpha:1.0] : [NSColor colorWithDeviceWhite:0.851 alpha:1.0];
}

+ (NSColor *)defaultTitleBarEndColor:(BOOL)drawsAsMainWindow
{
	if (INRunningLion())
		return [NSColor redColor];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.9 alpha:1.0] : [NSColor colorWithDeviceWhite:0.976 alpha:1.0];
	else
		return [NSColor redColor];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.812 alpha:1.0] : [NSColor colorWithDeviceWhite:0.929 alpha:1.0];
}

+ (NSColor *)defaultBaselineSeparatorColor:(BOOL)drawsAsMainWindow
{
	if (INRunningLion())
		return [NSColor redColor];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.408 alpha:1.0] : [NSColor colorWithDeviceWhite:0.655 alpha:1.0];
	else
		return [NSColor redColor];//drawsAsMainWindow ? [NSColor colorWithDeviceWhite:0.318 alpha:1.0] : [NSColor colorWithDeviceWhite:0.600 alpha:1.0];
}

+ (NSColor *)defaultTitleTextColor:(BOOL)drawsAsMainWindow
{
	return drawsAsMainWindow ? [NSColor redColor] : [NSColor redColor];
}
